...
describe('Pruebas en las acciones de Auth', () => {
    ...
    test('startLogin correcto', async() => {
        ...
        await store.dispatch( startLogin("facundo@gmail.com", "123456") );
    ...
    test('startLogin incorrecto', async() => {
        ...
        await store.dispatch( startLogin("facundo@gmail.com", "1234561322") );
        let actions = store.getActions();

        expect( actions ).toEqual([]);
        expect( Swal.fire ).toHaveBeenCalledWith("Error", "Password incorrecto", "error");

        await store.dispatch( startLogin("facundos@gmail.com", "123456") );
    ...
    test('startRegister correcto', async() => {
        ...
        expect( localStorage.setItem ).toHaveBeenCalledWith("token", "ASDA23424324");
        expect( localStorage.setItem ).toHaveBeenCalledWith("token-init-date", expect.any(Number));
